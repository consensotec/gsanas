...
import com.br.ipad.gsanas.model.Applicant;
...
public class ObservationAdapter extends BaseAdapter{
	...
	public ObservationAdapter(Context context, ArrayList<Applicant> applicant){
		c = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView = inflater.inflate(R.layout.file_adapter, null);
		}
		TextView name = (TextView) convertView.findViewById(R.id.name);
		name.setText(applicant.get(position).getApplicantName());
		if(position % 2 == 0){
